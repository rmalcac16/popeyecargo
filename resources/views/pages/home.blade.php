        ...
        <div class="mask w-slider-mask">
            <div class="slide first-slide w-slide">
                <div class="slider-container w-container">
                    <h1 class="hero banner">Servicio de transporte de Carga</h1>
                    <p class="banner-slider-description">Operador logístico confiable que ofrece una gama completa de servicios de transporte y gestión aduanera en todo el mundo.<br/></p>
...
<div class="section primary-light-bg">
    <div class="base-container w-container">
        <div class="title-wrapper width-700">
            <h2 class="text-center">Confía en PopeyeCargos SAC</h2>
            <p class="paragraph-description dark-gray"> En PopeyeCargos SAC, ofrecemos soluciones de transporte terrestre que conectan cada rincón del Perú. Con nosotros, tus envíos siempre estarán seguros, puntuales y respaldados por un equipo comprometido con la excelencia.</p>
        </div>
        <div class="help-wrapper top-space">
            <div class="help-wrap">
                <img src="https://cdn.prod.website-files.com/62f0e3371ad4ab59bf6b21b0/62f5fee9915f95842f9a9ff4_Box.jpg" loading="lazy" width="367" sizes="(max-width: 479px) 100vw, (max-width: 767px) 96vw, (max-width: 991px) 97vw, (max-width: 1279px) 33vw, 367px" alt="package delivery" srcset="https://cdn.prod.website-files.com/62f0e3371ad4ab59bf6b21b0/62f5fee9915f95842f9a9ff4_Box-p-500.jpg 500w, https://cdn.prod.website-files.com/62f0e3371ad4ab59bf6b21b0/62f5fee9915f95842f9a9ff4_Box.jpg 500w" class="solution-img"/>
            </div>
            <div class="help-animation">
            ...
            <div class="help-details-wrap">
                <div>
                    ...
                    <p class="paragraph-large dark-gray">Llegamos a varios destinos del Perú con seguridad y puntualidad.</p>
                </div>
                <div>
                    <h3>Atención Personalizada</h3>
                    <p class="paragraph-large dark-gray">Nuestro equipo se adapta a las necesidades de cada cliente.</p>
                </div>
                <div>
                    <h3>Compromiso y Seguridad</h3>
                    <p class="paragraph-large dark-gray">Aseguramos que cada envío sea tratado con el mayor cuidado y entregado puntualmente.</p>
                </div>
            </div>
        </div>
    </div>
